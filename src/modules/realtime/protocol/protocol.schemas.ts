...
const resultSchema = z.enum(['white_win', 'black_win', 'draw', 'void']);
...
// The concrete generic Zod object shape must stay inferred for discriminated unions.
